public class SmartDevice {
    ...
    public SmartDevice(String deviceName, String location, boolean isOnline, double powerConsumption) {
        ...
        this.connectedDevices = new String;
    ...
    public static void main(String[] args) {
        ...
        SmartDevice device1 = new SmartDevice("Living Room Speaker", "Living Room", false, 30.5);
        SmartDevice device2 = new SmartDevice("Thermostat", "Bedroom", false, 15.0);

        device1.setOnline(true).connectToDevice("Alexa").rename("Main Speaker");
        device2.performInitialSetup();
        device2.connectToDevice("Mobile").updatePowerConsumption(16.2);
